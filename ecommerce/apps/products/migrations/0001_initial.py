...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, default='hero', max_length=150, null=True, verbose_name='titre')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_promo', models.BooleanField(default=False, verbose_name='en promo')),
                ...
                ('specification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.specification')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/Users/abdulkabirkeita/Sites/service/core/core/static_cdn/protected_media'), upload_to=ecommerce.apps.products.models.upload_product_file_loc, verbose_name='fichier')),
                ('free', models.BooleanField(default=False, verbose_name='en telechargement libre ?')),
                ('user_required', models.BooleanField(default=False, verbose_name='proprietaire exigé')),
